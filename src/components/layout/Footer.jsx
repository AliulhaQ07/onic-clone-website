...
const Footer = () => {
  return (
    <>
      <footer className=" container mx-auto bg-neutral-50 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
          ...
          <div className="flex justify-center items-center">
            <a className="mr-6 text-neutral-900 dark:text-neutral-200">
              <svg
